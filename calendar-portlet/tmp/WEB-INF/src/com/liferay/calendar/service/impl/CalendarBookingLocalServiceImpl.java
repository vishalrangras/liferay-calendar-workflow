...
public class CalendarBookingLocalServiceImpl
	...
	public CalendarBooking addCalendarBooking(
		...
		// Calendar booking
		_log.info("=================================Adding CalendarBooking=====================================");
		...
		_log.info("=================================Starting Custom Workflow=====================================");
		
		CalendarWorkflowLocalServiceUtil.addCalendarWorkflow(user.getCompanyId(), calendar.getGroupId(), userId, calendarBookingId, startTime, titleMap, serviceContext);
	...
	public CalendarBooking deleteCalendarBooking(
		...
		for (CalendarBooking childCalendarBooking : childCalendarBookings) {
			// Calendar Workflow
			CalendarWorkflowLocalServiceUtil.removeCalendarWorkflow(childCalendarBooking.getCalendarBookingId());
	...
	public CalendarBooking deleteCalendarBooking(long calendarBookingId)
		...
		// Calendar Workflow
		CalendarWorkflowLocalServiceUtil.removeCalendarWorkflow(calendarBookingId);
	...
	public CalendarBooking moveCalendarBookingToTrash(
		...
		// Calendar Workflow
		CalendarWorkflowLocalServiceUtil.moveToTrashCalendarWorkflow(userId, calendarBooking.getCalendarBookingId(), serviceContext);
	...
	public CalendarBooking restoreCalendarBookingFromTrash(
		...
		CalendarWorkflowLocalServiceUtil.restoreCalendarWorkflow(calendarBookingId);
	...
	public CalendarBooking updateCalendarBooking(
		...
		_log.info("=================================Updating CalendarBooking=====================================");
		_log.info("=================================Starting Custom Workflow=====================================");
		User user = userPersistence.findByPrimaryKey(userId);
		CalendarWorkflowLocalServiceUtil.updateCalendarWorkflow(user.getCompanyId(), calendar.getGroupId(), userId, calendarBookingId, startTime, titleMap, serviceContext);
